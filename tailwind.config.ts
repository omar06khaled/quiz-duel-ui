    ...
    extend: {
      ...
      colors: {
        ...
        game: {
          ...
          "tile-disabled": "hsl(var(--game-tile-disabled))",
          gold: "hsl(var(--game-gold))",
          "gold-foreground": "hsl(var(--game-gold-foreground))",
          correct: "hsl(var(--game-correct))",
          incorrect: "hsl(var(--game-incorrect))",
          team1: "hsl(var(--game-team1))",
          team2: "hsl(var(--game-team2))",
      ...
      keyframes: {
        ...
        "pulse-glow": {
          "0%": { boxShadow: "0 0 0 0 hsl(var(--game-correct) / 0.5)" },
          "70%": { boxShadow: "0 0 0 14px hsl(var(--game-correct) / 0)" },
          "100%": { boxShadow: "0 0 0 0 hsl(var(--game-correct) / 0)" },
        },
        "float": {
